...
def test_citation_report():
    #Arrange
    url = "https://en.wikipedia.org/wiki/History_of_Mexico"
    arr = get_citations_needed_report(url).splitlines()
    print(arr)
